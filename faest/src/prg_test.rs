#[cfg(test)]
use crate::prg::{prg_128, prg_192, prg_256};
...
fn test_prg128() {
    ...
    let res = prg_128(&key, u128::from_be_bytes(iv), 15 * 16);
...
fn test_prg192() {
    ...
    let res = prg_192(&key, u128::from_be_bytes(iv), 15 * 16);
    assert_eq!(res, output)
}
...
fn test_prg256() {
    ...
    let res = prg_256(&key, u128::from_be_bytes(iv), 15 * 16);
    assert_eq!(res, output)
}
