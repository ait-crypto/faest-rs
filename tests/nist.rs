...
#[test]
fn faest_128s() {
    test_nist::<FAEST128sKeyPair, FAEST128sSignature>("PQCsignKAT_faest_128s.rsp");
}

#[test]
fn faest_128f() {
    test_nist::<FAEST128fKeyPair, FAEST128fSignature>("PQCsignKAT_faest_128f.rsp");
}

#[test]
fn faest_192s() {
    test_nist::<FAEST192sKeyPair, FAEST192sSignature>("PQCsignKAT_faest_192s.rsp");
}

#[test]
fn faest_192f() {
    test_nist::<FAEST192fKeyPair, FAEST192fSignature>("PQCsignKAT_faest_192f.rsp");
}

#[test]
fn faest_256s() {
    test_nist::<FAEST256sKeyPair, FAEST256sSignature>("PQCsignKAT_faest_256s.rsp");
}

#[test]
fn faest_256f() {
    test_nist::<FAEST256fKeyPair, FAEST256fSignature>("PQCsignKAT_faest_256f.rsp");
}

#[test]
fn faest_em_128s() {
    test_nist::<FAESTEM128sKeyPair, FAESTEM128sSignature>("PQCsignKAT_faest_em_128s.rsp");
}

#[test]
fn faest_em_128f() {
    test_nist::<FAESTEM128fKeyPair, FAESTEM128fSignature>("PQCsignKAT_faest_em_128f.rsp");
}

#[test]
fn faest_em_192s() {
    test_nist::<FAESTEM192sKeyPair, FAESTEM192sSignature>("PQCsignKAT_faest_em_192s.rsp");
}

#[test]
fn faest_em_192f() {
    test_nist::<FAESTEM192fKeyPair, FAESTEM192fSignature>("PQCsignKAT_faest_em_192f.rsp");
}

#[test]
fn faest_em_256s() {
    test_nist::<FAESTEM256sKeyPair, FAESTEM256sSignature>("PQCsignKAT_faest_em_256s.rsp");
}

#[test]
fn faest_em_256f() {
    test_nist::<FAESTEM256fKeyPair, FAESTEM256fSignature>("PQCsignKAT_faest_em_256f.rsp");
}
