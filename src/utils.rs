...
/// Converts a slice into a shared `Array` reference.
///
/// This is a small replacement for the deprecated `Array::from_slice`.
...
#[inline]
pub(crate) fn array_ref<T, N>(slice: &[T]) -> &Array<T, N>
where
    N: ArraySize,
{
    slice
